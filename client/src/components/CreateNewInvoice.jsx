  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <MenuItem onClick={() => setActivePage("Send Money")}>
            <ListItemIcon>
              <DashboardIcon fontSize="small" />
            </ListItemIcon>
            Send Money
          </MenuItem>
          <MenuItem onClick={() => setActivePage("Fund Wallet")}>
            <ListItemIcon>
              <DashboardIcon fontSize="small" />
            </ListItemIcon>
            Fund Wallet
          </MenuItem>
          <MenuItem onClick={() => setActivePage("Convert Funds")}>
            <ListItemIcon>
              <DashboardIcon fontSize="small" />
            </ListItemIcon>
            Convert Funds
      ...
      >
        ...
        >
          ...
          {selectedCustomer && (
            <Typography sx={{ mt: 1 }}>Selected: {selectedCustomer}</Typography>
          )}
        </Box>
      ...
      {successMessage && (
        <Alert severity="success" sx={{ width: "60%", margin: "10px auto" }}>
          {successMessage}
        </Alert>
      )}
